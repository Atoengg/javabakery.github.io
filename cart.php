...
<head>
  ...
  <title>Cart | Java Bakery & Cake</title>
  ...
  <div class="page-content page-cart">
              ...
              <?php 
                ...
                <?php foreach ($carts as $cart) : ?>
                  <?php 
                    ...
                    $banyak += $cart["banyak"];
                    $total = $banyak * $cart["price"];
                    if ($total >= 10000){
                      $diskon = (($total*10)/100);
                      $total_bayar = ($total-$diskon);
                    } else {
                      $total_bayar = $cart["banyak"] * $cart["price"];
                    }
                  ...
                  <tr>
                    ...
                    <td style="width: 20%;">
                      <div class="product-title">Rp. <?= number_format($total); ?></div>
                      <div class="product-subtitle">IDR</div>
                    </td>
                    <td style="width: 10%;">
        ...
        <form action="" method="POST">
          ...
          <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="col-4 col-md-3">
              <div class="product-title"><?= number_format($banyak); ?> Roti</div>
              <div class="product-subtitle mb-3">Banyak Roti</div>
            </div>
            <div class="col-4 col-md-3">
            ...
            <div class="col-4 col-md-3">
              <div class="product-title text-success">Rp. <?= number_format($diskon); ?></div>
              <div class="product-subtitle">Diskon</div>
            </div>
            <div class="col-4 col-md-3">
              <div class="product-title text-success">Rp. <?= number_format($total_bayar); ?></div>
              
              <div class="product-subtitle">Total bayar</div>
            </div>
            <div class="col-8 col-md-3">
              <input type="hidden" name="user_id" value="<?= $user["id_user"]; ?>">
              <input type="hidden" name="weight" value="<?= $berat; ?>">
              <input type="hidden" name="total_price" value="<?= $total_bayar; ?>">
    ...
    <footer>
      <div class=" container">
        <div class="row">
          <div class="col-12">
            <p class="pt-4 pb-2">&copy; <?= date('Y'); ?> Copyright by Kelompok 5 E-Businnes dan E-Commerce. All Rights Reserved.</p>
          </div>
        </div>
      </div>
    </footer>
