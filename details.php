...
<html lang="en">
  <head>
    ...
    <title>Details | Java Bakery & Cake</title>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 d-flex justify-content-between">
                <div>
                  ...
                  <div class="form-group d-flex align-items-center justify-content-between" style="width: 150px;">
                    <input type="number" required name="banyak" id="banyak" class="form-control w-50" value="1" min="0">Banyak
                  </div>
                  <div class="price">Rp. <?= number_format($product["price"]); ?></div>                    
                </div>
                <div>
                  <p>
                    Tersedia : <strong><?= $product["stock"] /1000; ?> Stock</strong>
                  </p>
                </div>
              </div>
              ...
              <div class="col-lg-2" data-aos="zoom-in">
                  <a
                    href="login.php"
                    class="btn btn-success px-4 text-black btn-block mb-3 py-2"
                  >
                    Sign in to cart
                  </a>
              </div>
