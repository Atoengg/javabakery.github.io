...
<html lang="en">
  ...
  <body>
    ...
    <div class="page-content page-home" data-aos="zoom-in">
      <section class="store-landing" style="background: url('./imagesz/banner lo.jpg'); background-repeat: no-repeat; background-size: cover; background-attachment: fixed; padding: 130px 0 130px 0;">
        <div class="container">
          <div class="row align-items-center justify-content-between">
            <div class="col-md-5">
              <img src="imagesz/logo new.png" class="w-100" alt="" />
            </div>
            <div class="col-md-6">
              <h1 style="text-align:center; font-weight: bold; margin-bottom: 15px;">Toko Java <wbr /> Bakery & Cake <wbr /> Online Enak dan Lezat</h1>
              <p class="store-subtitle-landing" style="text-align: justify; line-height: 28px; color: black;">
                Java Bakery & Cake adalah toko online yang menjual berbagai macam roti,
                roti tersebut diolah dengan dengan baik sehingga kualitas roti sangat bagus dan harganya juga mudah dijangkau.
                ayo segera! temukan roti kesayangan anda di toko ini.
              </p>
  ...
  <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
      ...
      <section class="store-adventeges" style="margin-top: 0px;" id="adventeges">
        <div class="container">
          <div class="row">
            <div class="col-12">
                ...
                <div class="card-body">
                  <div class="row justify-content-center align-content-center">
                    ...
                    <div class="col-md-8">
                      ...
                      >
                        <div class="title-text" style=" text-align: center;">Pengiriman Sangat Cepat</div>
                        <div class="subtitle-text" style="text-align: center;">
                          Barang sampai ditempat dengan aman
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row justify-content-center align-content-center">
                    ...
                    <div class="col-md-8">
                      <div
                        class="adventege-description text-center text-lg-left"
                      >
                        <div class="title-text" style="text-align: center;">Lebih Efesien</div>
                        <div class="subtitle-text" style="text-align: center;">
                          menghemat waktu anda, sehingga anda belanja lebih cepat, dan kami memberi anda diskon 
                          10% jika pembelian lebih dari Rp.10.000
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row justify-content-center align-content-center">
                    ...
                    <div class="col-md-8">
                      <div
                        class="adventege-description text-center text-lg-left"
                      >
                        <div class="title-text" style="text-align: center;">Ramah Lingkungan</div>
                        <div class="subtitle-text" style="text-align: center;">
                          bungkus roti yang kami gunakan sudah ramah lingkungan
                          jadi sudah dipastikan sangat aman
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <section class="store-products-kilogram" style="margin-top: 60px;">
        <div class="container">
          <div class="row">
              ...
              >
                ...
                <a href="details.php?id=<?= $idProduct; ?>" class="component-products d-block">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                      <div class="text-muted"><?= $product["stock"]/1000; ?> Stok</div>
                    </div>
                  </div>
                </a>
                <?php else : ?>
                <div class="component-products d-block">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                      <div class="text-muted"><?= $product["stock"]; ?> Stok</div>
                    </div>
                  </div>
                </div>
                <?php endif;?>
