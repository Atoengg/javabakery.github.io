...
<html lang="en">
  <head>
    ...
    <title>Login | Java Bakery & Cake</title>
        ...
        <div class="container">
          <div class="row align-items-center row-login">
            <div class="col-lg-6 text-center">
              <img
                src="imagesz/vektor1.jpg"
                alt=""
                class="w-50 mb-lg-none"
              />
            </div>
            <div class="col-lg-5">
              <h2 class="mb-4">Belanja aneka roti menjadi lebih mudah</h2>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-12">
            <p class="pt-4 pb-2">
            2022 Copyright by Kelompok 5 E-Businnes dan E-Commerce. All Rights Reserved.
            </p>
          </div>
        </div>
      </div>
